...
| `xhs hydrate <id_or_url_or_index>` | Fetch normalized note detail plus top comments | `xhs hydrate 1 --comment-limit 5 --yaml` |
...
| `xhs --cdp-port 9222 login` | Read decrypted cookies from a running Chromium browser |
