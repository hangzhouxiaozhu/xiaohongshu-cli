...
class TestGetCookies:
    def test_prefers_cdp_when_port_is_set(self, monkeypatch):
        ...
        monkeypatch.setattr("xhs_cli.cdp_cookies.extract_cdp_cookies", lambda port, host: extracted)
    ...
    def test_failed_cdp_falls_back_to_saved_cookies(self, monkeypatch):
        monkeypatch.setattr("xhs_cli.cdp_cookies.extract_cdp_cookies", lambda port, host: None)
